...
<body>
    ...
    if (isset($_SESSION["amministratore"])) {
        ...
        if ($risultato->num_rows > 0) {
            while ($record = $risultato->fetch_assoc()) {
                ...
                echo "<b>Cliente</b>: <a id='cliente' href='./info_cliente.php?email=$emailCliente'>$congomeCliente $nomeCliente</a> <br>";
                ...
                echo "<button name='edit_progetto' id='edit_progetto'>Modifica dati</button>";
                echo "<button name='visualizza_tasks' id='visualizza_tasks'>Visualizza tasks</button>";
                echo "</form>";
                echo "</div>";
                echo "</section>";
            }
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        } else if (isset($_POST["visualizza_tasks"])) {
            header("Location: visualizza_tasks.php?progetto=$idProgetto");
        } else {
            echo "Errore";
        }
    }
